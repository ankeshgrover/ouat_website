 ...
 * ==========================================================================
 *
 * Once Upon A Time – AJAX Portfolio HTML5 Template
 *
 * [Table of Contents]
 *
 * 1. Animations
...
// Modal Stories--------------------------------------------------------------------------------
const popups = [
	{ title: "Childhood Memories", description: "I was born on January 10th, 1953, in Munnar, Kerala, South India. It's one of the most beautiful places on earth, often called God's own country. <br> <br>I was the fifth child in a family of seven – five boys and two girls. Being the fifth, I imagine there wasn't much excitement or fanfare around my arrival. Just one more added to the family, I guess. At that time, there was no electricity, telephone, or television. My parents tell me the refrigerator ran on kerosene. The climate was very cold and misty. Newspapers arrived every 2 or 3 days. For communication, we relied on occasional letters or, in emergencies, telegrams.<br><br>And thus began the humble beginnings of my story!", images: ["../img/assets/timeline/img1_1.png", "../img/assets/timeline/img2_1.png", "../img/assets/timeline/img3_1.png"] },

	{ title: "School and College Days", description: "As a child, I liked science and math the most. Geography, however, was not my cup of tea. I always struggled with maps and remembering routes. To this day, my geography is very weak. I can’t remember directions! Science and math were my favorites, but I wasn’t a sports person. I did participate in co-curricular activities like drama. I remember playing the role of a queen in a historical drama and also a role in Panna Dhai, along with smaller parts in other plays. Dance and music, though, were not for me. Dance especially was, and still is, not my cup of tea.", images: ["../img/assets/timeline/img1_2.png", "../img/assets/timeline/img2_2.png", "../img/assets/timeline/img3_2.png"] },

	{ title: "Early Adulthood", description: "There was no single 'aha' moment that sparked my interest in teaching. No inspiring figure in my family, no transformative classroom experience. Instead, it seemed to blossom from a simple, innate curiosity. I was drawn to the world of children, fascinated by their unbridled energy and eager minds. My earliest memories of this budding interest involve observing toddlers—watching them explore their world with a kind of untamed wonder that both amused and intrigued me. <br> <br>Perhaps it was this fascination that prompted me to consider a Bachelor of Education (BEd) degree. It felt like the “safest side,” a practical choice should I ever decide to join the workforce. This was after my postgraduate studies, mind you! Before that, my teenage self had quite different aspirations.", images: ["../img/assets/timeline/img1_3.png", "../img/assets/timeline/img2_3.png", "../img/assets/timeline/img3_3.png"] },

	{ title: "Building My Family", description: "It was only when I held my son, in my arms for the first time that the true depths of motherhood washed over me. That overwhelming surge of love, fierce and protective – it was unlike anything I'd ever experienced. My daughter, followed two years later, and our family was complete. Raising children while working and navigating the complexities of a joint family had its challenges. There were times when I yearned for a deeper understanding from my in-laws, especially when juggling work and home life became overwhelming. They were incredibly supportive, of course, always there to lend a hand with the children. But there were moments, fleeting yet poignant, where I craved acknowledgment of my struggles, a recognition of the unique pressures I faced as a working mother in our family.", images: ["../img/assets/timeline/img1_4.png", "../img/assets/timeline/img2_4.png", "../img/assets/timeline/img3_4.png"] },

	{ title: "Building a Career, Purpose, or Contribution", description: "In today's world, it's almost unimaginable to start and end your career with the same company. But that was my reality. I joined a tea plantation as an assistant manager in 1975 and retired as General Manager in 2013, after a fulfilling 38-year journey.<br><br>When my dream of becoming a doctor didn't materialize, I found myself at a crossroads, contemplating my future. It was then that I decided to embark on a career in the tea plantation industry, a decision that would profoundly shape my life. Reflecting on my 38-year career in the tea plantation industry fills me with deep nostalgia and pride. My journey from assistant manager to general manager was a long and rewarding path, marked by significant responsibilities, unique experiences, and profound personal and professional growth", images: ["../img/assets/timeline/img1_5.png", "../img/assets/timeline/img2_5.png", "../img/assets/timeline/img3_5.png"] },

	{ title: "Triumphs & Challenges", description: "The year 2021 was a time when the world grappled with the severe impacts of the COVID-19 pandemic. Like many others, I faced an intense experience that will forever be etched in my memory. During the peak of the pandemic, we found ourselves needing to travel to Singapore to be with our daughter and her family. Before we could join them, however, we were required to quarantine for 14 days in a hotel. This wasn't just a simple stay; it was isolation, a lockdown within a lockdown, where the concept of freedom took on a whole new meaning. <br> <br>Fourteen days, 336 hours, 20,160 minutes, 1,209,600 seconds. Even after the quarantine ended, the impact of those 14 days lingered. The memory of being locked down, unable to step outside, left a lasting impression, a stark reminder of the unprecedented times we lived through.", images: ["../img/assets/timeline/img1_6.png", "../img/assets/timeline/img2_6.png", "../img/assets/timeline/img3_6.png"] },

	{ title: "Golden Years", description: "My life after retirement has been an incredibly transformative phase, one that shifted my focus from relentless professional pursuits to the joys and passions I had long postponed. The years leading up to retirement were marked by an unyielding schedule, filled with professional obligations, where time for self-care, leisure, or deep family connections was scarce. I was immersed in a career that demanded all my energy and attention, leaving limited opportunities for relaxation or exploration. As I bid farewell to my career, I made a conscious and firm decision to forgo any additional assignments or part-time work that might tether me back to that lifestyle. This was the time to live life on my own terms. <br> <br>Retirement is a consequential life change, offering a unique opportunity to start anew, to move beyond the past and embrace the future. It's a blank page, a chance to redesign life into something new and different. And what a wonderful thing it is! I get to enjoy all the things I never stopped to notice on the way up. After an extraordinary career, it was time to savor retirement, the only time one can truly appreciate all the good things life has to offer without the stress of a job.", images: ["../img/assets/timeline/img1_7.png", "../img/assets/timeline/img2_7.png", "../img/assets/timeline/img3_7.png"] },

	{ title: "Wisdom and Reflections", description: "Reflecting on my journey through life, I realize it has been filled with beautiful memories and invaluable experiences. Looking back at the different times and phases, I am grateful for each chapter that has shaped me. Writing this book has been a profound journey into my past, one that rekindled countless nostalgic memories, moments of laughter and warmth, and even a few bittersweet tears. Each memory brought with it a sense of wonder, allowing me to relive the path I have traveled, a path paved with love, growth, and cherished experiences.<br> <br>This beautiful endeavor wouldn't have been possible without Aswathy, Ankesh, and Arjun. For my last birthday on January 10th, they gifted me this opportunity—a chance to pen down the essence of my life, a story uniquely mine, yet interwoven with the lives of so many loved ones. This thoughtful gift was more than I could ever ask for. It was a chance to gather the reflections and experiences that have made me who I am. <br> <br>I had never written a book before and initially felt apprehensive. Putting my thoughts and memories into words felt daunting at first. But after a few stories, I began to enjoy the process. There were so many memories to choose from! It was a joy to revisit those moments and decide which ones to include, though it was challenging because, in truth, every experience held its own unique beauty. ", images: ["../img/assets/timeline/img1_8.png", "../img/assets/timeline/img2_8.png", "../img/assets/timeline/img3_8.png"] },
	

	{ title: "Legacy & Hopes for the Future", description: "Dear Daughter, If ever there is a tomorrow when we are not together, there is something you must always remember. You are braver than you believe, stronger than you seem, and smarter than you think. But the most important thing is, even if we are apart, we will always be with you. We love you. We don't say it out of habit. We say it to remind you that you are the best thing that ever happened to us. We loved you then, love you still, and always will. You have brought so much meaning to our lives. <br> <br>Yesterday you were a baby in my arms. I looked at your precious face and wondered where life would take you. <br>Today, I look at the person you have become—strong, kind, thoughtful, caring, and optimistic. I realize that the dreams I held in my heart for you are alive in your beautiful spirit. We are so proud of you and love you with all our hearts, forever.", images: ["../img/assets/timeline/img1_9.png", "../img/assets/timeline/img2_9.png", "../img/assets/timeline/img3_9.png"] },
];
